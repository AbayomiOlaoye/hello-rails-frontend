...
```sh
  git clone https://www.github.com/AbayomiOlaoye/hello-rails-frontend.git
  cd hello-rails-frontend
```
...
- **Improve the UI**
- **Implement other features like memes**
...
Feel free to check the [issues page](https://github.com/AbayomiOlaoye/hello-rails-frontend/issues).
